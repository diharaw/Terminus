...
StringHash InputMapImpl::name()
{
    return m_name;
}

uint32_t InputMapImpl::num_states()
{
    return m_state_map.count;
}

uint32_t InputMapImpl::num_axis()
{
    return m_axis_map.count;
}

uint32_t InputMapImpl::num_actions()
{
    return m_action_map.count;
}

void InputMapImpl::set_action(uint64_t hash, int32_t mouse, int32_t keyboard, int32_t gamepad)
{
    if(mouse != -1)
...
void InputMapImpl::clear_state(StringHash hash)
{
...
void InputMapImpl::clear_axis(StringHash hash)
{
