...
{
    return get_elapsed_time_sec();
}

double Timer::get_elapsed_time_sec()
{
    return get_elapsed_time_microsec() * 0.000001;
}

double Timer::get_elapsed_time_milisec()
{
    return get_elapsed_time_microsec() * 0.001;
}
